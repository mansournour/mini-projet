...
final class AuthorController extends AbstractController
{
    ...
    #[Route('/showAuthor/{username}', name: 'showAuthor')]
    public function showAuthor($username): Response
    {
...
array('id' => 2, 'picture' => '/images/willliam.jpg','username' => ' William Shakespeare', 'email' =>
